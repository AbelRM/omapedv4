    ...
    <main id="main">
      <div class="form">
        ...
        <?php
          ...
          //consulta de la BD
          $sql = mysqli_query($conexion,"SELECT * from pcd WHERE id="$id"") 
        ...
        ?> 
          <div class="form-group">
            ...
            <input class="form-info" type="text" name="nombre" id="nombre" maxlength="100" value="<?php echo $registro['nombre']; ?>" required>
          </div>
          <div class="form-group">
